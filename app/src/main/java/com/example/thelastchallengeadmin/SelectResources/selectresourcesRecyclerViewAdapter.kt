...
class selectresourcesRecyclerViewAdapter (
    private val models: ArrayList<selectresourcesrecyclerviewmodel>,
    private val listener: OnItemClickListener
) : RecyclerView.Adapter<selectresourcesRecyclerViewAdapter.ViewzHolder>() {

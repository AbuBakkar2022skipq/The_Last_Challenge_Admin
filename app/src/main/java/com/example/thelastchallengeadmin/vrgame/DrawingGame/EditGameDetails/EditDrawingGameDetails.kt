package com.example.thelastchallengeadmin.vrgame.DrawingGame.EditGameDetails
...
class EditDrawingGameDetails : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.editdrawinggame)
    ...
    private fun setvalues() {
        ...
        gameinfo["documentId"] = "drawingGame"
        //gameinfo["resources"]= forbiddenwordsshareddata.selectedwordss
        gameinfo["get"] = true

        //Uploading Data to Firestore
        db.collection("drawingGame").document("drawingGame")
            .set(gameinfo)
    ...
    private fun uploadImageToFirebaseStorage() {
        val ref = FirebaseStorage.getInstance().reference.child("drawingGame")

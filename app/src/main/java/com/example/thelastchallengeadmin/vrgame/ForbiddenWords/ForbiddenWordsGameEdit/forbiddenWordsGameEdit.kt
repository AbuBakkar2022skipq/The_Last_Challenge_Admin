package com.example.thelastchallengeadmin.vrgame.ForbiddenWords.ForbiddenWordsGameEdit
...
import com.example.thelastchallengeadmin.vrgame.ForbiddenWords.RecyclerViewForbiddenWords.selectForbiddenWords
...
class forbiddenWordsGameEdit : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_forbidden_words_game_edit)
        ...
        addresources.setOnClickListener {
            val intent = Intent(this, selectForbiddenWords::class.java)
    ...
    private fun setvalues() {
        ...
        gameinfo["documentId"] = "forbiddenWords"
        //gameinfo["resources"]= forbiddenwordsshareddata.selectedwordss
        gameinfo["get"] = true

        //Uploading Data to Firestore
        db.collection("forbiddenWords").document("forbiddenWords")
            .set(gameinfo)
    ...
    private fun uploadImageToFirebaseStorage() {
        val ref = FirebaseStorage.getInstance().reference.child("ForbiddenWords")

package com.example.thelastchallengeadmin.vrgame.LaughWars
...
class LaughWarsMenu : AppCompatActivity() {
    ...
    private fun setvalues() {
        ...
        gameinfo["documentId"] = "laughWars"
        //gameinfo["resources"]= forbiddenwordsshareddata.selectedwordss
        gameinfo["get"] = true

        //Uploading Data to Firestore
        db.collection("laughWars").document("laughWars")
            .set(gameinfo)
    ...
    private fun uploadImageToFirebaseStorage() {
        val ref = FirebaseStorage.getInstance().reference.child("LaughWars")

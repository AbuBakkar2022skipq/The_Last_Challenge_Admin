package com.example.thelastchallengeadmin.vrgame.Mimicry.Words.RecyclerView
...
class RecyclerViewAdapterForWords(
    private val models: ArrayList<recyclerViewDataModel>,
    private val listener: OnItemClickListener
) : RecyclerView.Adapter<RecyclerViewAdapterForWords.ViewzHolder>() {

    private lateinit var mlistener: OnItemClickListener
    @SuppressLint("InflateParams")
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewzHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.recyclerview_resource_wrt_words, null)

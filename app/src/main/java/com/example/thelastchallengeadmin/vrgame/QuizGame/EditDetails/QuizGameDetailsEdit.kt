package com.example.thelastchallengeadmin.vrgame.QuizGame.EditDetails
...
import kotlinx.android.synthetic.main.activity_mimicry_menu.textView222
import kotlinx.android.synthetic.main.addpunishment.*

class QuizGameDetailsEdit: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.quizgamedetailsedit)
    ...
    private fun uploadImageToFirebaseStorage() {
        val ref = FirebaseStorage.getInstance().reference.child("QuizGame")

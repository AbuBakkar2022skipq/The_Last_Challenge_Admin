package com.example.thelastchallengeadmin.vrgame.Songs.SongDetails
...
class SongDetails: AppCompatActivity() {
    ...
    private fun setvalues() {
        ...
        gameinfo["documentId"] = "songsdeets"
        //gameinfo["resources"]= forbiddenwordsshareddata.selectedwordss
        gameinfo["get"] = true

        //Uploading Data to Firestore
        db.collection("songsdeets").document("songsdeets")
            .set(gameinfo)
    ...
    private fun uploadImageToFirebaseStorage() {
        val ref = FirebaseStorage.getInstance().reference.child("Songs")

package com.example.thelastchallengeadmin.vrgame.StrungWords.StrungWordsEditGame
...
class StrungWords  : AppCompatActivity() {
    ...
    private fun setvalues() {
        ...
        gameinfo["documentId"] = "strungWords"
        //gameinfo["resources"]= forbiddenwordsshareddata.selectedwordss
        gameinfo["get"] = true

        //Uploading Data to Firestore
        db.collection("strungWords").document("strungWords")
            .set(gameinfo)
    ...
    private fun uploadImageToFirebaseStorage() {
        val ref = FirebaseStorage.getInstance().reference.child("StrungWords")

package com.example.thelastchallengeadmin.vrgame.TheLetter
...
class TheLetterDetailsEdit : AppCompatActivity() {
    ...
    private fun setvalues() {
        ...
        gameinfo["documentId"] = "theLetter"
        //gameinfo["resources"]= forbiddenwordsshareddata.selectedwordss
        gameinfo["get"] = true

        //Uploading Data to Firestore
        db.collection("theLetter").document("theLetter")
            .set(gameinfo)
    ...
    private fun uploadImageToFirebaseStorage() {
        val ref = FirebaseStorage.getInstance().reference.child("TheLetter")
